package genericUtilities;
	...
	public class WebDriverUtility {
		...
		/**
		 * This method is uesd to wait until title appears on the web page 
		 * @param time
		 * @param title
		 * @return
		 */
		 ...
		 * @param driver
		 */
		public void captureScreenshot(String className,JavaUtility jutil,WebDriver driver) {
		...
		/**
		 * This method is used to scroll till the specified element
		 * @param element
		 */
		 ...
		 * @return
		 */
		public WebElement convertPathToElement(String path,String replaceData) {
